...
// node_modules/flowbite-react/lib/esm/components/Button/Button.js
var ButtonComponentFn = ({ children, className, color = "info", disabled, fullSized, isProcessing = false, processingLabel = "Loading...", processingSpinner, gradientDuoTone, gradientMonochrome, label, outline = false, pill = false, positionInGroup = "none", size: size4 = "md", theme: customTheme = {}, ...props }, ref) => {
...
var Trigger = ({ refs, children, inline: inline4, theme: theme2, disabled, setButtonWidth, getReferenceProps, renderTrigger, ...buttonProps }) => {
  ...
  return inline4 ? (0, import_jsx_runtime32.jsx)("button", { type: "button", ref: refs.setReference, className: theme2 == null ? void 0 : theme2.inlineWrapper, disabled, ...a11yProps, children }) : (0, import_jsx_runtime32.jsx)(Button, { ...buttonProps, disabled, type: "button", ref: refs.setReference, ...a11yProps, children });
};
...
// node_modules/flowbite-react/lib/esm/components/Modal/Modal.js
var ModalComponent = (0, import_react32.forwardRef)(({ children, className, dismissible = false, onClose, popup, position = "center", root, show, size: size4 = "2xl", theme: customTheme = {}, initialFocus, ...props }, theirRef) => {
...
var RatingStar = ({ className, filled = true, starIcon: Icon = HiStar, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime66.jsx)(Icon, { "data-testid": "flowbite-rating-star", className: twMerge(theme2.sizes[size4], theme2[filled ? "filled" : "empty"], className), ...props });
};
...
var RatingComponent = ({ children, className, size: size4 = "sm", theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime67.jsx)(RatingContext.Provider, { value: { theme: theme2, size: size4 }, children: (0, import_jsx_runtime67.jsx)("div", { className: twMerge(theme2.root.base, className), ...props, children }) });
};
